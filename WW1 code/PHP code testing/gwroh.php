...
<head>
  ...
  <style>
    /* Ensure table container works with flex layout */
    .table-container {
      flex: 1;
      min-width: 0;
    }
...
<div class="container">
  ...
  <div class="main-content">
    <!-- Table Container with scrollable wrapper (unchanged) -->
      ...
      <div class="scrollable-table">
        <table id="dataTable">
          ...
          <tr>
            ...
            <!-- All cells as originally defined -->
  ...
  <!-- Bottom section: search results left, nav arrows center, back button right -->
