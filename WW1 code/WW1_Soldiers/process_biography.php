...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $checkQuery = "SELECT COUNT(*) as count FROM Biography_Information WHERE `Service_no` = ?";
        ...
        if (!empty($serviceNo) && $recordExists) {
            ...
            $updateQuery = "UPDATE Biography_Information SET Surname=?, Forename=?, Regiment=?, `Service_no`=?, Biography=? WHERE `Service no`=?";
            ...
            // Insert new record
            $insertQuery = "INSERT INTO Biography_Information (Surname, Forename, Regiment, `Service_no`, Biography) VALUES (?, ?, ?, ?, ?)";
