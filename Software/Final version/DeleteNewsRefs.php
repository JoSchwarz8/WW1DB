...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $newspaperDate = $_POST['NewspaperDate'] ?? ''; // Make sure the front-end sends this field name exactly
    ...
    $sql = "DELETE FROM Newspaper_ref WHERE Surname = ? AND Forename = ? AND NewspaperDate = ?";
